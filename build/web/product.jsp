<%-- 
    Document   : product
    Created on : Jul 12, 2021, 8:28:50 PM
    Author     : DELL
--%>
...
<body>
    <c:set var="sp" value="${requestScope.sp}"></c:set>
                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" src="assets/images/product-phone/${sp.linkanh}"  alt="product image">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">${sp.tensp}</h1><!-- End .product-title -->
