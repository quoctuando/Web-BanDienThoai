<%-- 
    Document   : cart
    Created on : Jul 7, 2021, 2:51:27 PM
    Author     : DELL
--%>
	                			...
	                			<table class="table table-cart table-mobile">
									...
									<tbody>
                                                                        <c:forEach var="item" items="${sessionScope.cart }">
                                                                            <c:set var="total" value="${total + item.sp.gia * item.soluong }"></c:set>
                                                                            <tr>
                                                                                <td class="product-col">
                                                                                    <div class="product">
                                                                                        <figure class="product-media">
                                                                                            <a href="#">
                                                                                                <img src="assets/images/product-phone/${item.sp.linkanh}" alt="Product image">
                                                                                            </a>
                                                                                        </figure>

                                                                                        <h3 class="product-title">
                                                                                            <a href="#">${item.sp.tensp}</a>
                                                                                        </h3> 
                                                                                    </div> 
                                                                                </td>
                                                                                <td class="price-col">$${item.sp.gia}</td>
                                                                                <td class="quantity-col">
                                                                                    <div class="cart-product-quantity">
                                                                                        <input type="number" class="form-control" value="${item.soluong}" >
                                                                                    </div>  
                                                                                </td>
                                                                                <td class="total-col">${item.sp.gia * item.soluong }</td>
...
<!--										<tr>
	                		...
	                		<aside class="col-lg-3">
		            			...
		            			<a href="<%= request.getContextPath() %>/" class="btn btn-outline-dark-2 btn-block mb-3"><span>CONTINUE SHOPPING</span><i class="icon-refresh"></i></a>
	                		</aside><!-- End .col-lg-3 -->
	                	</div><!-- End .row -->
	                </div><!-- End .container -->
                </div><!-- End .cart -->
