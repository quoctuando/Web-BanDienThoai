<%-- 
    Document   : HomePage
    Created on : Jul 6, 2021, 4:21:57 PM
    Author     : DELL
--%>
...
<body>
    <%! List<sanpham> listOfNewReleases=new ArrayList<sanpham>(); %>
    <%! List<sanpham> listOfMostExpensive=new ArrayList<sanpham>(); %>
    <%! List<sanpham> listOfBestRated=new ArrayList<sanpham>(); %>
    <%
        SanPhamDao spd = new SanPhamDao();
        listOfNewReleases = spd.getNewReleasesSanPham();
        listOfMostExpensive = spd.getMostExpensiveSanPham();
        listOfBestRated=spd.getBestRatedSanPham();
    %>
                                ...
                                <div class="dropdown cart-dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="dropdown-cart-action">
                                            <a href="<%= request.getContextPath() %>/CartServlet?&action=view" class="btn btn-primary">View Cart</a>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="assets/images/menu/bannerIphone11" alt="Banner">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html">
                                                            <img src="assets/images/menu/bannerLumia.jpg" alt="Banner">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 d-none d-xl-block">
                            <nav class="side-nav">
                                <div class="sidenav-title">Browse Categories</div><!-- End .sidenav-title -->
                                        ...
                                        <div class="megamenu megamenu-sm">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html">
                                                            <img src="assets/images/demos/demo-19/menu/bannerLumia.jpg" alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-md-6 -->
                                            </div><!-- End .row -->
                                        ...
                                        <div class="megamenu">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="assets/images/demos/demo-19/menu/bannerIphone11.jpg" alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner banner-overlay -->
                                                </div><!-- End .col-md-4 -->
                                            </div><!-- End .row -->
                        ...
                        <div class="col-lg-8 col-xl-6">
                            <div class="banner banner-overlay banner-lg  content-left">
                                <a href="#">
                                    <img src="assets/images/demos/demo-19/banners/bannerIphone11.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="banner banner-overlay banner-sm content-right">
                                <a href="#">
                                    <img src="assets/images/demos/demo-19/banners/bannerLumia.jpg" alt="Banner">
                                </a>
                            ...
                            <div class="banner banner-overlay d-none d-lg-block banner-sm content-right align-center">
                                <a href="#">
                                    <img src="assets/images/demos/demo-19/banners/bannerNever.jpg" alt="Banner">
                                </a>
                                <div class="banner-content text-right">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="banner banner-overlay banner-sm content-right align-center">
                                <a href="#">
                                    <img src="assets/images/demos/demo-19/banners/bannerSamsung.jpg" alt="Banner">
                                </a>
                        ...
                        <div class="col-lg-9">
                            <div class="banner banner-overlay banner-lg">
                                <a href="#">
                                    <img src="assets/images/demos/demo-19/banners/bannerSamsung2.jpg" alt="Banner">
                                </a>
                                <div class="banner-content">
                ...
                <div class="bg-light pt-3 pb-5 mb-5">
                    <div class="container">
                        <ul class="nav nav-pills nav-big nav-border-anim justify-content-center mb-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="products-trending-link" data-toggle="tab" href="#products-trending-tab" role="tab" aria-controls="products-trending-tab" aria-selected="true">New Releases</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="products-new-link" data-toggle="tab" href="#products-new-tab" role="tab" aria-controls="products-new-tab" aria-selected="false">Most Expensive</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content tab-content-carousel">
                            <div class="tab-pane p-0 fade show active" id="products-trending-tab" role="tabpanel" aria-labelledby="products-trending-link">
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <c:forEach items="<%=listOfNewReleases%>" var="sp">
                                        <div class="product">
                                        <figure class="product-media">
                                            <a href="<%= request.getContextPath() %>/ProductServlet?&id=${sp.id}">
                                                <img src="assets/images/product-phone/${sp.linkanh}" alt="Product image" class="product-image">
                                            </a>
                                            ...
                                            <div class="product-action">
                                                <a href="<%= request.getContextPath() %>/CartServlet?&action=buy&id=${sp.id}" class="btn-product btn-cart"><span>add to cart</span></a>
                                            </div>  
                                        </figure>  
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="#.html">${sp.tensp}</a></h3> End .product-title 
...
<!--                                    
                            ...
                            <div class="tab-pane p-0 fade" id="products-new-tab" role="tabpanel" aria-labelledby="products-new-link">
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <c:forEach items="<%=listOfMostExpensive%>" var="sp">
                                        <div class="product">
                                        <figure class="product-media">
                                            <a href="<%= request.getContextPath() %>/ProductServlet?&id=${sp.id}">
                                                <img src="assets/images/product-phone/${sp.linkanh}" alt="Product image" class="product-image">
...
<!--                                    <div class="product">
                            ...
                            <div class="tab-pane p-0 fade" id="products-best-tab" role="tabpanel" aria-labelledby="products-best-link">
                                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <c:forEach items="<%=listOfBestRated%>" var="sp">
                                        <div class="product">
                                        <figure class="product-media">
                                            <a href="<%= request.getContextPath() %>/ProductServlet?&id=${sp.id}">
                                                <img src="assets/images/product-phone/${sp.linkanh}" alt="Product image" class="product-image">
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="assets/images/demos/demo-19/products/macbook.jpg" alt="Product image" class="product-image">
                                </a>
